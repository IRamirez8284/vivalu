					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 3008938453</a></li>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="{{ url('/wish-list') }}"><i class="fa fa-star"></i> Mis Favoritos</a></li>
								<li><a href="{{ url('/orders') }}"><i class="fa fa-crosshairs"></i> Mis Pedidos</a></li>
								<li><a href="{{ url('/cart') }}"><i class="fa fa-shopping-cart"></i> Cart ({{ $cartCount }})</a></li>
								@if(empty(Auth::check()))
									<li><a href="{{ url('/login-register') }}"><i class="fa fa-lock"></i> Iniciar Sesión</a></li>
								@else
									<li><a href="{{ url('/account') }}"><i class="fa fa-user"></i> Mi Cuenta</a></li>
									<li><a href="{{ url('/user-logout') }}"><i class="fa fa-sign-out"></i> Cerrar Sesión</a></li>
								@endif
							</ul>
						</div>
					</div>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="{{ url('page/post') }}">Contacto</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
